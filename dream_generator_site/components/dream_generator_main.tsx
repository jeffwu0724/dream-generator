...
const Dream_generator_main: React.FC = () => {
  ...
  const ENDPOINT: string =
    "https://m8gmbpw6uc.execute-api.us-west-1.amazonaws.com/prod/generate_story";
  ...
  if (hasResult) {
    displayedElement = (
      <Results enriched_story={enriched_story} onBack={onBack} story={story} picture_url={picture_url}/>
    );
  } else {
